...
<body>
    ...
    <h2 class="text-center">Aplikasi Data Leptop</h2>
    <p class="font-weight-light text-center">IQBAL SUBEKHAN (18090006)</p>
   ...
   <a href="{{route('buku.create')}}" class="btn btn-success mb-2">Tambah</a>
    ...
    <table class="table table-striped ">
        <thead class="thead-dark">
          <tr>
            <th scope="col">NO</th>
            <th scope="col">Gambar leptop</th>
            <th scope="col">Merk leptop</th>
            <th scope="col">Seri leptop</th>
